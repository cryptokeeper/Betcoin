...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // Betcoin: 1 day(s)
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "7th of the first month of 2 Thousand and fourteen";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
